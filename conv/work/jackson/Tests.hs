...
transitives = [
	...
	"Did a supervisor work in the the State of Colorado?",
	...
	"A supervisor worked as a supervisor.",
	...
	"A supervisor studied counseling.",
	"Did a supervisor study in the United States?",
	"A supervisor studied counseling at a shelter.",
	"A supervisor studied counseling at school.",
	...
	"Some woman told a story.",
	"Did a supervisor come from the State of Colorado?",
	"Did Queen immigrate?",
	"Did a supervisor immigrate to the State of Colorado?",
...
ditransitive_tests = [
	...
	"A supervisor gave some lotion to Queen's son.",
	"Did a supervisor give some lotion to Queen's son.",
	"Did a supervisor give the lotion to Queen's daughter?",
	"Did a supervisor give the lotion to someone?",
	"A supervisor gave a ten_dollar_bill to Queen's son.",
	"Did someone give something to Queen's daughter?",
	"A woman gave the lotion to Queen's son.",
	"A woman gave the lotion to someone.",
	"A woman gave something to someone.",
	"Someone gave something to someone.",
	"A supervisor gave Queen's daughter some birthday_card.",
	"Did a supervisor give Queen's daughter some birthday_card?",
	"Did a supervisor give Queen's daughter the birthday_card?",
	"Did a supervisor give someone the birthday_card?",
