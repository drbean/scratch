...
haves = [
	"Did Derek have a father?",
	"Did Derek have a mother?",
	"Did Derek have a daughter?",
	"Did Derek's father have a troop?",
	"Did Richard have a job?",
	"Did Richard have some job?",
	"Did Richard have a troop?",
	"Did Richard have a wife?",
	"Did Richard have sons?",
	"Did Richard have daughters?",
	"Did Randy have a parent?",
	"Did Randy have some parents?",
	"Did Randy have parents?",
	"Did Randy's father have a troop?",
	"Did Randy's father have some scouts?",
	"Did Randy's father have scouts?",
	"Did Randy have work?",
	"Did Richard work?",
	"Did Richard have work?",
	"Did Richard have a job?",
	"Did Derek have work?",
	"Did Derek have a job?",
	"Did Derek's father have work?",
	"Did a leader have a job?",
	"Did a leader have a woman's job?",
	"Did a leader have Derek's job?",
	"Did a leader have a mother?",
	"Did a leader have a daughter?",
	"Did a disabled man have parents?",
	"Did a disabled man have some parents?",
	"Did a mentally-disabled man's leader have some daughters?",
	"Did a disabled boy's leader have Troop 409?",
	"Did the daughters have a troop?",
	"Did the daughter have a father?",
	"Richard's scouts had disabilities."
	]
