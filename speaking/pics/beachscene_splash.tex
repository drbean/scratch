...
\mycard{1/1}{beachscene, splash}{
\begin{itemize*}
\item %convertible — noun: 1. A car whose roof can be removed or folded, 2. (finance) A hybrid security that can be converted into stock — adjective: 1. Able to be converted,
\item %sports car — noun: 1. An automobile designed for high speed and power, tight handling, and flashy looks.
\end{itemize*}
}
\end{textblock}
