...
shoes = [
	...
	, "Where has Dr.Bean see QuanJiaFu?"
	...
	, "What kind of shoes did the store has ?"
...
"
	...
	, "Did the         shoe shore have the women’s shoes?"
"
"
...
yn_test = [
	"Was YingTsai Lu too far for Dr.Bean?"
	, "Did Dr.Bean buy the slippers for 800NT?"
	, "Did Dr.Bean see QuanJiaFu in Toufen and Zhunan?"
	, "Did Dr.Bean want to buy shoes in Toufen?"
	, "Did Dr.Bean want to buy jogging shoes in QuanJiaFu ?"
	, "Did Dr.Bean go to  QuanJiafu to buy shoes?"
	, "Did  QuanJiafu give Dr.Bean some discount?"
	, "Were those shoes good for a teacher?"
	, "Can Dr.Bean buy jogging shoes at  QuanJiafu?"
	, "Did Dr.Bean buy jogging shoes cheaper than 499NT?"
	, "Did Dr.Bean want to pay 1000NT for shoes?"
	, "Did Miaoli have a QuanJiaFu store?"
	, "Are the shoes in QuanJiaFu cheapest?"
	, "Did Dr.Bean want to buy the shoes in Miaoli?"
	, "Did Dr.Bean buy shoes in QuanJiaFu store ?"
	, "Did Dr.Bean pay more than 1000NT to buy the shoes?"
	...
	, "Did Dr Bean buy shoes at QuanLian?"
	, "Did Dr Bean go to QuanLian?"
	, "Did Dr Bean go to QuanLian to buy shoes?"
	, "Did Dr Bean buy QuanLian's shoes?"
	, "Did Dr Bean like QuanLian's shoes?"
	, "Did Dr Bean buy shoes?"
	, "Did Dr Bean buy shoes from QuanJiaFu?"
	, "Did Dr Bean want to buy shoes from QuanJiaFu?"
	, "Did Dr Bean want to buy shoes at QuanLian?"
	, "Did Dr Bean like shoes?"
	, "Did Dr Bean like shoes?"
	, "Did Dr Bean like shoes from QuanLian?"
	, "Did Dr Bean like the shoes from QuanLian?"
	, "Did Dr Bean like the shoes from QuanLian?"
