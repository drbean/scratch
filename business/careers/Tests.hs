...
test_text = [
	...
	"Barbara's boss had a brother and a brother was German.",
...
comp_test1 = [
	...
	"Jennifer was the German woman's mother.",
	"Jennifer was the German woman's boss.",
	"Jennifer was a German woman's boss.",
...
test_possessives = [
	...
	"Did Jennifer's mother give a birthday card to the German woman's boss?",
	"Did Jennifer's mother give a birthday card to a German woman's boss?",
	...
	"Did the co-worker of the German woman have money?",
	...
	"Did the boss of the German woman have money?",
