...
To: $display $addresspart\\
	...
	" < ~/job/parttime_coverletter | mutt  -e "set copy=yes" -e "my_hdr To: $display $addresspart" -e "my_hdr From: Greg Matheson <drbean@freeshell.org>" -s "Part-time job in Taiping: inquiry by Greg Matheson" 
