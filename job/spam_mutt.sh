...
To: $display $addresspart\\
	...
	" < ~/job/translation_coverletter | mutt  -e "set copy=yes" -e "my_hdr To: $display $addresspart" -e "my_hdr From: Greg Matheson <drbean@freeshell.org>" -s "Part-time job inquiry by Greg Matheson" -a ~/html/P6270001.JPG -a ~/html/passport.jpg -a ~/html/diploma.jpg -a ~/job/teaching_certificate.jpg
