...
my $name = Shop->config->{database};
my $db = Shop->path_to( 'db', $name );
...
Shop::Model::DB - Catalyst DBIC Schema Model
=head1 SYNOPSIS
...
L<Catalyst::Model::DBIC::Schema> Model using schema L<Shop::Schema>
