...
inoremap \1 :call Oneword()o
inoremap \Pr :call Predicate()$i
inoremap \T :call Transitive()o
inoremap \O :call Object()o
inoremap \P :call Name()o
inoremap \C :call Constantterm()o
inoremap \I :call Interp()o
inoremap \N :call CommonNoun()o
...
set shortmess=aoO
badd +1 Evaluation.hs
badd +1 Parsing.hs
badd +1 Cats.hs
badd +50 Interpretation.hs
badd +1 Questioner.hs
badd +1 adventure.cabal
silent! argdel *
edit Questioner.hs
...
setlocal formatexpr=
setlocal formatoptions=nwcroql
