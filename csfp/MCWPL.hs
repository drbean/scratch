module MCWPL (Term(..), NP(..), DET(..), RCN, Formula(..)) where 
...
-- int0 "SnowWhite" = \[_] -> True
-- int0 "Alice" = \[_] -> True
int0 "Girl" = \ [x]     -> girl x
int0 "Boy" = \ [x]     -> boy x
int0 "Person" = \ [x]     -> person x
...
fint2 "SnowWhite" [] = S
fint2 "Alice" [] = A
fint2 "LittleMook" [] = littleMook
fint2 "R" [] = R

checkForm :: Formula Term -> Bool
checkForm f = evl entities int0 fint2 (\(Variable _ _) -> A) f

checkSentence :: Sent -> Bool

checkSentence s = evl entities int0 fint2 (\ (Variable _ _) -> A) ( lfSent s )
