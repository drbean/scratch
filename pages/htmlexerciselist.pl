...
href=http://203.64.184.141/cgi-bin/<TMPL> $location </TMPL>/script_files/<TMPL> $location </TMPL>_cgi.pl/login?exercise=<TMPL> $id </TMPL>><TMPL> $id </TMPL></a> exercise. (You will be asked to log in.)
</p>
<p>
If that link doesn\'t work, try the <a href="http://sac.nuu.edu.tw/cgi-bin/<TMPL> $location </TMPL>/script_files/<TMPL> $location </TMPL>_cgi.pl/login?exercise=<TMPL> $id </TMPL>"> alternative <TMPL> $id </TMPL> exercise link </a>.
</div>
