...
<p>
If that link doesn\'t work, try the <a href="http://sac.nuu.edu.tw/cgi-bin/<TMPL> $location </TMPL>/script_files/dic_cgi.pl/login?exercise=<TMPL> $id </TMPL>"> alternative $id exercise link </a>.
</div>
