...
href=http://210.60.168.195/cgi-bin/<TMPL> $location </TMPL>/script/<TMPL> $location </TMPL>_cgi.pl/login?exercise=<TMPL> $id </TMPL>><TMPL> $id </TMPL></a> exercise. (You will be asked to log in.)
</p>
<p>
